  ...
  return (
    <footer className="relative overflow-hidden bg-background py-16 md:py-20">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
              ...
              {navLinks.map((link) => (
                <li key={link.href}>
                  <button
                    ...
                    className="inline-flex rounded-full border border-white/[0.08] bg-white/[0.03] px-4 py-2 text-sm text-zinc-400 transition-all duration-200 hover:border-white/15 hover:bg-white/[0.06] hover:text-white"
                  >
                    {link.label}
                  </button>
                </li>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col items-center justify-between gap-4 text-center text-xs text-zinc-500 sm:flex-row sm:text-left">
          <span suppressHydrationWarning>
            © {new Date().getFullYear()} Guayaba Devs. Hecho con cariño por la comunidad.
          </span>
          <button
            onClick={() => scrollToSection("/#hero")}
            className="inline-flex items-center gap-1.5 rounded-full border border-white/[0.08] bg-white/[0.03] px-4 py-2 text-xs text-zinc-400 transition-all duration-200 hover:border-white/15 hover:bg-white/[0.06] hover:text-white"
          >
            Volver arriba
