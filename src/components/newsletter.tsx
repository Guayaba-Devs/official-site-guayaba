...
export const Newsletter = () => {
  ...
  return (
    <section className="mt-6 px-4 md:px-8 lg:px-12">
      ...
      <div className="flex flex-col-reverse md:grid md:grid-cols-5 gap-6 items-center justify-between">
        <Card className="mx-auto md:col-span-3 bg-gray-900 px-4 py-6 md:py-4 border border-gray-600 w-full max-w-lg md:max-w-none">
