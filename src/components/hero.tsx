...
export const Hero = () => {
  ...
  const [currentSlideIndex, showSlide] = useReducer(
    ...
    <div className="relative z-30 min-h-screen flex items-center px-4 sm:px-6 lg:px-8 xl:px-16 pt-20">
      <div className="max-w-4xl w-full text-center md:text-left">
        <div className="mb-6 sm:mb-8 flex justify-center md:justify-start">
          <div className="size-20 sm:size-28 rounded-full flex items-center justify-center shadow-2xl shadow-primary/20 border border-white/15 bg-black/30 backdrop-blur-md">
            <div className="relative size-14 sm:size-20 rounded-full overflow-hidden">
              <Image
        ...
        <h1
          ref={titleRef}
          className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-semibold mb-4 sm:mb-6 text-primary drop-shadow-2xl"
        ...
        >
          <a
            ...
            className="group"
          >
            <button className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 sm:px-8 sm:py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-3 shadow-xl shadow-primary/30 hover:shadow-2xl hover:shadow-primary/40">
              <span>Únete a la comunidad</span>
              <svg
                className="size-4 sm:size-5 transition-transform duration-300 group-hover:translate-x-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <button
            ...
            className="group"
          >
            <span className="border border-white/20 text-white hover:bg-white/10 hover:border-white/30 px-6 py-3 sm:px-8 sm:py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-3 backdrop-blur-md bg-white/5">
              <span>Próximos eventos</span>
              <svg
                className="size-4 sm:size-5 transition-transform duration-300 group-hover:translate-y-1"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
